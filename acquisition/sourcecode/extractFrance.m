...
timeextract = datetime(currenttime,'TimeZone','UTC') - hours(12);
...
url = ['https://opendata.reseaux-energies.fr/api/records/1.0/search/?dataset=eco2mix-national-tr&q=date_heure%3A%5B' ...
        startingdate '+TO+' ...
        endingdate ...
        '%5D&rows=3000&sort=-date_heure&facet=nature&facet=date_heure'] ;

% url_past = ['https://opendata.reseaux-energies.fr/api/records/1.0/search/?dataset=eco2mix-national-cons-def&q=date_heure%3A%5B' ...
%                 startingdate '+TO+' ...
%                 endingdate ...
%                 '%5D&rows=3000&sort=-date_heure&facet=nature&facet=date_heure'] ;
% url_present = ['https://opendata.reseaux-energies.fr/api/records/1.0/search/?dataset=eco2mix-national-tr&q=date_heure%3A%5B' ...
%         startingdate '+TO+' ...
%         endingdate ...
%         '%5D&rows=3000&sort=-date_heure&facet=nature&facet=date_heure'] ;
try
